"use strict";(self.webpackChunk_ant_design_web3_docs=self.webpackChunk_ant_design_web3_docs||[]).push([[4591],{71788:function(t,n,e){e.r(n),e.d(n,{customToken:function(){return r},themeList:function(){return d}});var p=e(90156),r={token:{borderRadius:16,wireframe:!1,padding:24,paddingSM:16,paddingXS:12,fontSize:16,fontSizeLG:18,fontSizeHeading4:24,fontSizeHeading5:20,fontSizeHeading2:36,fontSizeXL:24,colorPrimary:"#8442ff",colorInfo:"#8442ff",paddingContentHorizontal:20,paddingContentHorizontalSM:16,paddingContentHorizontalLG:24},components:{Button:{controlHeight:44,marginXS:8,fontSizeLG:18,controlHeightLG:52,controlHeightSM:36,paddingXS:16},List:{paddingLG:24,marginLG:24,marginXXL:48,paddingContentHorizontalLG:24,fontSizeLG:20,padding:16,paddingContentVertical:24,paddingXS:8,paddingSM:12},Modal:{controlHeightLG:44,fontSizeHeading5:20,fontSizeLG:18,marginSM:12,margin:16,marginLG:24,marginXS:8,padding:16,paddingContentHorizontalLG:24,paddingLG:24,paddingMD:20,paddingXS:12}}},d=[{color:"#1677FF",value:"default",name:"Default",token:{token:{}}},{color:"#000",value:"dark",name:"Dark",token:{token:{borderRadius:2,colorPrimary:"#000",colorPrimaryTextHover:"rgba(255, 255, 255, 0.8)",colorLink:"rgba(255, 255, 255, 0.75)",colorText:"rgba(255, 255, 255, 0.75)"},components:{Button:{defaultHoverColor:"rgba(255, 255, 255, 0.8)",defaultHoverBorderColor:"rgba(255, 255, 255, 0.8)"}},algorithm:p.Z.darkAlgorithm}},{value:"green",name:"Forest green",color:"#00B96B",token:{token:{colorPrimary:"#00B96B",borderRadius:4,colorLink:"#00B96B"}}},{value:"pink",name:"Blossom",color:"#ED4192",token:{token:{colorPrimary:"#ED4192",borderRadius:16,colorLink:"#ED4192"}}},{color:"#8343FF",value:"violet",name:"Violet",token:r}]},61547:function(t,n,e){e.r(n);var p=e(1735),r=e(11620),d=e(56557),m=e(10862),i=e(50190),a=e(72152),s=function(o){var c=o.mode,u=o.size,l=o.quickConnect;return(0,a.jsx)(m.N,{autoConnect:!0,wallets:[(0,i.x5)(),(0,i.Oq)(),(0,i.Yw)()],children:(0,a.jsx)(r.w,{modalProps:{mode:c},children:(0,a.jsx)(d.N,{type:"primary",style:{width:"auto"},size:u,quickConnect:l})})})};n.default=s},31225:function(t,n,e){e.r(n);var p=e(1735),r=e(11620),d=e(56557),m=e(75898),i=e(27630),a=e(42543),s=e(72418),C=e(96690),o=e(72152),c=function(l){var g=l.mode,f=l.size,_=l.quickConnect;return(0,o.jsx)(m.h,{eip6963:{autoAddInjectedWallets:!0},walletConnect:{projectId:"c07c0051c2055890eade3556618e38a6"},ens:!0,wallets:[(0,i.M)(),(0,a.b)(),(0,s.g)({group:"Popular"}),(0,C.Y)()],children:(0,o.jsx)(r.w,{modalProps:{mode:g},children:(0,o.jsx)(d.N,{type:"primary",style:{width:"auto"},size:f,quickConnect:_})})})};n.default=c},88205:function(t,n,e){e.r(n);var p=e(1735),r=e(11620),d=e(56557),m=e(67788),i=e(13370),a=e(72152),s=function(o){var c=o.mode,u=o.size,l=o.quickConnect;return(0,a.jsx)(m.G,{wallets:[(0,i.GU)(),(0,i.j1)()],children:(0,a.jsx)(r.w,{modalProps:{mode:c},children:(0,a.jsx)(d.N,{type:"primary",style:{width:"auto"},size:u,quickConnect:l})})})};n.default=s},73767:function(t,n,e){e.r(n);var p=e(1735),r=e(11620),d=e(56557),m=e(22099),i=e(56046),a=e(72152),s=function(o){var c=o.mode,u=o.size,l=o.quickConnect;return(0,a.jsx)(m.r,{balance:!0,autoConnect:!0,wallets:[(0,i.h)(),(0,i.t)()],children:(0,a.jsx)(r.w,{modalProps:{mode:c},children:(0,a.jsx)(d.N,{type:"primary",style:{width:"auto"},size:u,quickConnect:l})})})};n.default=s},40702:function(t,n,e){e.r(n);var p=e(1735),r=e(11620),d=e(56557),m=e(46215),i=e(93626),a=e(66207),s=e(72152),C=function(c){var u=c.mode,l=c.size,g=c.quickConnect;return(0,s.jsx)(m.q,{wallets:[i._,a.x,{key:"safepalwallet"}],children:(0,s.jsx)(r.w,{modalProps:{mode:u},children:(0,s.jsx)(d.N,{type:"primary",style:{width:"auto"},size:l,quickConnect:g})})})};n.default=C},46078:function(t,n){n.Z=`import React, { useEffect } from 'react';
...
`},57325:function(t,n){n.Z=`import { Address, ConnectButton, Connector, NFTCard } from '@ant-design/web3';
import { MetaMask, WagmiWeb3ConfigProvider } from '@ant-design/web3-wagmi';
...
`},22442:function(t,n){n.Z=`import React, { useEffect } from 'react';
import { Address, ConnectButton, Connector, NFTCard, useAccount } from '@ant-design/web3';
...
`},36455:function(t,n){n.Z=`import React from 'react';
...
export default App;
`},33257:function(t,n){n.Z=`import React from 'react';
...
export default App;
`},32505:function(t,n){n.Z=`import { ConnectButton, Web3ConfigProvider, zh_CN } from '@ant-design/web3';
...
export default App;
`},29637:function(t,n){n.Z=`import { ConnectButton, Web3ConfigProvider } from '@ant-design/web3';
...
export default App;
`},46750:function(t,n){n.Z=`import { ConnectButton } from '@ant-design/web3';
...
export default App;
`},16487:function(t,n){n.Z=`import { NFTImage } from '@ant-design/web3';
...
export default App;
`},30944:function(t,n){n.Z=`import React from 'react';
import { ConnectModal, type Wallet } from '@ant-design/web3';
import { metadata_MetaMask, metadata_WalletConnect } from '@ant-design/web3-assets';
...
export default App;
`},97842:function(t,n){n.Z=`import type { ThemeConfig } from 'antd';
...
`},45702:function(t,n){n.Z=`import React from 'react';
...
export default App;
`},73520:function(t,n){n.Z=`import React from 'react';
import type { ConnectModalProps } from '@ant-design/web3';
import { ConnectButton, Connector } from '@ant-design/web3';
import {
  MetaMask,
...
export default App;
`},39100:function(t,n){n.Z=`import React from 'react';
import type { ConnectModalProps } from '@ant-design/web3';
...
export default App;
`},33592:function(t,n){n.Z=`import React from 'react';
import type { ConnectModalProps } from '@ant-design/web3';
import { ConnectButton, Connector } from '@ant-design/web3';
...
export default App;
`},21265:function(t,n){n.Z=`import React from 'react';
import type { ConnectModalProps } from '@ant-design/web3';
import { ConnectButton, Connector } from '@ant-design/web3';
...
export default App;
`},75509:function(t,n){n.Z=`import React from 'react';
import type { ConnectModalProps } from '@ant-design/web3';
import { ConnectButton, Connector } from '@ant-design/web3';
