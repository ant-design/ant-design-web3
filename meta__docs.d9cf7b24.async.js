...
`,paraId:19,tocIndex:5},{value:"You can also follow the following related issues to get the latest progress:",paraId:20,tocIndex:5},{value:"https://github.com/ant-design/ant-design-icons/issues/605",paraId:21,tocIndex:5}]},87278:function(d,a,e){e.r(a),e.d(a,{texts:function(){return t}});const t=[{value:"Ant Design Web3 is developed based on Ant Design, and you can set the theme of Ant Design Web3 by configuring ",paraId:0,tocIndex:0},{value:"Ant Design's theme",paraId:0,tocIndex:0},{value:".",paraId:0,tocIndex:0},{value:"Ant Design Web3 has built-in support for dark mode, which inherits the configuration from Ant Design.",paraId:1,tocIndex:1},{value:"You can also completely customize Ant Design's ",paraId:2,tocIndex:2},{value:"Design Token",paraId:2,tocIndex:2},{value:", which we will inherit and use in Ant Design Web3. If you find that the Design Token is not supported or used incorrectly, please ",paraId:2,tocIndex:2},{value:"submit an issue",paraId:2,tocIndex:2},{value:" to tell us.",paraId:2,tocIndex:2}]},83948:function(d,a,e){e.r(a),e.d(a,{texts:function(){return t}});const t=[]},23403:function(d,a){a.Z=`import { Address, ConnectButton, Connector, NFTCard, useAccount } from '@ant-design/web3';
...
`},21406:function(d,a){a.Z=`import { Address, ConnectButton, Connector, NFTCard } from '@ant-design/web3';
import { MetaMask, WagmiWeb3ConfigProvider } from '@ant-design/web3-wagmi';
import { createConfig, http } from 'wagmi';
import { mainnet } from 'wagmi/chains';
import { injected } from 'wagmi/connectors';
...
`},41820:function(d,a){a.Z=`import { Address, ConnectButton, Connector, NFTCard, useAccount } from '@ant-design/web3';
...
`},39392:function(d,a){a.Z=`import React from 'react';
...
export default App;
`},10784:function(d,a){a.Z=`import React from 'react';
...
export default App;
`},49536:function(d,a){a.Z=`import React from 'react';
...
export default App;
`},2426:function(d,a){a.Z=`import { ConnectButton, Web3ConfigProvider, zh_CN } from '@ant-design/web3';
...
export default App;
`},920:function(d,a){a.Z=`import { ConnectButton, Web3ConfigProvider } from '@ant-design/web3';
...
export default App;
`},31572:function(d,a){a.Z=`import { ConnectButton } from '@ant-design/web3';
...
export default App;
`},69432:function(d,a){a.Z=`import { NFTImage } from '@ant-design/web3';
import { WagmiWeb3ConfigProvider } from '@ant-design/web3-wagmi';
import { createConfig, http } from 'wagmi';
import { mainnet } from 'wagmi/chains';
...
export default App;
`},47894:function(d,a){a.Z=`import React from 'react';
import { ConnectModal, type Wallet } from '@ant-design/web3';
import { metadata_MetaMask, metadata_WalletConnect } from '@ant-design/web3-assets';
...
export default App;
`},77323:function(d,a){a.Z=`import type { ThemeConfig } from 'antd';
