...
const features: FeatureType[] = [
  {
    icon: 'https://mdn.alipayobjects.com/huamei_mutawc/afts/img/A*PrKkS6nw7mEAAAAAAAAAAAAADlrGAQ/original',
  ...
  {
    icon: 'https://mdn.alipayobjects.com/huamei_mutawc/afts/img/A*3T_-RJIV_uQAAAAAAAAAAAAADlrGAQ/original',
  ...
  {
    icon: 'https://mdn.alipayobjects.com/huamei_mutawc/afts/img/A*yOzMS4Gob14AAAAAAAAAAAAADlrGAQ/original',
