...
import { eraseDefaultProps } from '../utils';import SVGComponent from '../svgs/evx-circle-colorful.svg';
...
export const EvxCircleColorful = React.forwardRef<HTMLSpanElement, IconBaseProps>((props, ref) => {
