...
export default App;
`},22300:function(o,n){n.Z=`import { Account, ConnectButton, Connector } from '@ant-design/web3';
import {
  MetaMask,
  OkxWallet,
  Sepolia,
...
export default App;
`},76203:function(o,n){n.Z=`import { NFTCard } from '@ant-design/web3';
import { ConfigProvider, Space, theme } from 'antd';
